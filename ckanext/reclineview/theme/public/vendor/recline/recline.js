...
}(this.recline.Backend.DataProxy, this.ckan));
this.recline = this.recline || {};
this.recline.Backend = this.recline.Backend || {};
...
}(this.recline.Backend.Memory, this.ckan));
